...
HD_PWD='C:/Users/akhil/verilog/Alarm Clock/Alarm Clock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Aclock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Aclock.tcl
